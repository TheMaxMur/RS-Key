...
(*    `compact()` returns Ok (firmware/src/main.rs:609-620) -- marker AFTER  *)
...
CONSTANTS
    ...
    \* The marker written on a lap that did NOT complete: firmware/src/main.rs:619
...
\* leaves the marker unset, firmware/src/main.rs:619).
