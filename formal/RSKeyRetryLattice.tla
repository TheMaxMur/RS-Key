...
CONSTANTS
    ...
    \* crates/rsk-piv/src/lib.rs:1186-1188 (check_ref) and
    ...
    BugUseWhenBlocked,
    \* The decrement that IS the anti-bruteforce gate: crates/rsk-piv/src/lib.rs:1204
    ...
    \* crates/rsk-piv/src/lib.rs:1337 (`check_ref(EF_PUK, ..)` opens
...
\* RESET RETRY (crates/rsk-piv/src/lib.rs:534-541, crates/rsk-openpgp/src/pin.rs:743-793),
...
(***************************************************************************)
(* VERIFY. crates/rsk-piv/src/lib.rs:1181-1244 (check_ref) and              *)
