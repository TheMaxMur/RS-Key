...
CONSTANTS
    ...
    \* crates/rsk-piv/src/lib.rs:1200-1202 (check_ref) and
    ...
    BugUseWhenBlocked,
    \* The decrement that IS the anti-bruteforce gate: crates/rsk-piv/src/lib.rs:1218
    ...
    \* crates/rsk-piv/src/lib.rs:1351 (`check_ref(EF_PUK, ..)` opens
...
\* RESET RETRY (crates/rsk-piv/src/lib.rs:548-555, crates/rsk-openpgp/src/pin.rs:743-793),
...
(***************************************************************************)
(* VERIFY. crates/rsk-piv/src/lib.rs:1195-1258 (check_ref) and              *)
