...
CONSTANTS
    ...
    \* crates/rsk-piv/src/lib.rs:1198-1200 (check_ref) and
    ...
    BugUseWhenBlocked,
    \* The decrement that IS the anti-bruteforce gate: crates/rsk-piv/src/lib.rs:1216
    ...
    \* crates/rsk-piv/src/lib.rs:1349 (`check_ref(EF_PUK, ..)` opens
...
\* RESET RETRY (crates/rsk-piv/src/lib.rs:546-553, crates/rsk-openpgp/src/pin.rs:743-793),
...
(***************************************************************************)
(* VERIFY. crates/rsk-piv/src/lib.rs:1193-1256 (check_ref) and              *)
