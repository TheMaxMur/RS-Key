...
STORE_INV=(NoOrphanedMetadata NoFalseAbsent NoRecordLostToMetaWrite)
...
emit_boot() { # $1 = cfg, $2 = switch (""), $3 = 1 for solo
  local out=$1 on=${2:-} solo=${3:-0}
  {
    echo "\\* Generated by formal/gen-configs.sh -- do not edit by hand."
    echo "SPECIFICATION Spec"
    echo "CONSTANTS"
    echo "    PowerOnClearsScratch2 = TRUE"
    echo "    MaxWeak = 2"
...
echo "wrote Boot.cfg and ${#BOOT_BUGS[@]} x 2 boot configs"
...
# other observer.
emit_security_trace() { # $1 = cfg, $2 = beta mutation, $3 = alpha mutation, $4 = R4b
  local out=$1 beta=$2 alpha=$3 r4b=$4
  {
    echo "\* Generated by formal/gen-configs.sh -- do not edit by hand."
    echo "SPECIFICATION TraceSpec"
    echo "CONSTANTS"
...
emit_security_trace TraceSecurity.cfg FALSE FALSE TRUE
emit_security_trace TraceSecurityBadBeta.cfg TRUE FALSE TRUE
emit_security_trace TraceSecurityBadAlpha.cfg FALSE TRUE TRUE
emit_security_trace TraceSecurityBadAlphaNoR4b.cfg FALSE TRUE FALSE
echo "wrote TraceSecurity baseline, two divergence configs, and the R4b control"
